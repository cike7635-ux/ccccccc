// /app/components/themes/delete-theme-button.tsx - 新增弹窗版本
'use client';
    ...
    <>
      ...
      {showDialog && (
        ...
        >
          {/* 弹窗内容 */}
          <div 
            className="relative w-full max-w-md bg-gradient-to-br from-gray-900 to-gray-950 border border-gray-700/50 rounded-2xl shadow-2xl overflow-hidden animate-fade-in"
